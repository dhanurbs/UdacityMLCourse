...
cleaned_data = []
cleaned_data = zip(ages_train, net_worths_train, abs(predictions-net_worths_train))
...
if len(cleaned_data) > 0:
    ...
    plt.show()
    print 'Refitted Regresion without Outliers, Slope: ', reg.coef_, ' and Intercept: ', reg.intercept_
    print 'R-Sq score after removing outliers: ' , reg.score(ages_test, net_worths_test)
